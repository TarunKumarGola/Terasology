...
public class ModuleDetailsScreen extends CoreScreenLayer {
    ...
    private Module minVersion;
    @Override
    public void initialise() {
        setAnimationSystem(MenuAnimationSystems.createDefaultSwipeAnimation());

        initWidgets();
      /*change one*/  dependencyResolver = new DependencyResolver(moduleManager.getRegistry());
    ...
    private void setUpDependencies() {
        ...
        dependencies.setItemRenderer(new AbstractItemRenderer<DependencyInfo>() {
            ...
            public void draw(DependencyInfo value, Canvas canvas) {
                minVersion=moduleManager.getRegistry().getLatestModuleVersion(value.getId());
                if (moduleManager.getRegistry().getLatestModuleVersion(value.getId())==null) {
                    canvas.setMode("invalid");
                } else {
                    String s=String.valueOf(minVersion);
                         ...
                         String str2=String.valueOf(value.getMinVersion());
    ...
    public void setModules(final Collection<Module> modules) {
        if (modules != null) {
       /*second change*/     moduleList.setItemRenderer(new AbstractItemRenderer<Module>() {
